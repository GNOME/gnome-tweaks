...
TWEAK_GROUPS = [
    ...
    ListBoxTweakGroup(_("Legacy"),
        ...
        Title(_("Window"), "", uid="title-theme"),
        GSettingsSwitchTweak(_("Attach modal dialog to the parent window"),"org.gnome.mutter", "attach-modal-dialogs"),
        GSettingsSwitchTweak(_("Whether rasing should be a side-effect of other user interactions"),"org.gnome.desktop.wm.preferences", "raise-on-click"),
        GSettingsSwitchTweak(_("Whether to resize with the right button"),"org.gnome.desktop.wm.preferences", "resize-with-right-button"),
        GSettingsComboTweak(_("Modifier to use for modified window click actions"),
